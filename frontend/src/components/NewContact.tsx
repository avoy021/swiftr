    ...
    return (
        ...
        {isOpen && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center z-50" onClick={closeModal}>
              <div
                className="bg-white p-6 rounded-2xl shadow-xl min-w-[300px] max-w-[90%]"
              ...
              >
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white shadow-sm transition duration-150 cursor-pointer"
                  >
                    Save
                  </button>
                </div>
